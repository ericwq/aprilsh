...
type Instruction struct {
	...
	OldNum          int64  `protobuf:"varint,2,opt,name=old_num,json=oldNum,proto3" json:"old_num,omitempty"`
	NewNum          int64  `protobuf:"varint,3,opt,name=new_num,json=newNum,proto3" json:"new_num,omitempty"`
	AckNum          int64  `protobuf:"varint,4,opt,name=ack_num,json=ackNum,proto3" json:"ack_num,omitempty"`
	ThrowawayNum    int64  `protobuf:"varint,5,opt,name=throwaway_num,json=throwawayNum,proto3" json:"throwaway_num,omitempty"`
...
func (x *Instruction) GetOldNum() int64 {
	if x != nil {
		return x.OldNum
	}
	return 0
...
func (x *Instruction) GetNewNum() int64 {
	if x != nil {
		return x.NewNum
	}
	return 0
...
func (x *Instruction) GetAckNum() int64 {
	if x != nil {
		return x.AckNum
	}
	return 0
...
func (x *Instruction) GetThrowawayNum() int64 {
	if x != nil {
...
var file_protobufs_transportInstruction_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6f, 0x6c, 0x64, 0x4e, 0x75, 0x6d, 0x12, 0x17, 0x0a, 0x07,
	0x6e, 0x65, 0x77, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e,
	0x65, 0x77, 0x4e, 0x75, 0x6d, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x12, 0x23,
	0x0a, 0x0d, 0x74, 0x68, 0x72, 0x6f, 0x77, 0x61, 0x77, 0x61, 0x79, 0x5f, 0x6e, 0x75, 0x6d, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x74, 0x68, 0x72, 0x6f, 0x77, 0x61, 0x77, 0x61, 0x79,
